...
- 顶部显示当前家庭名称，旁边新增一个小型切换图标；点击图标弹出下拉菜单，列出用户加入的全部家庭（包括共享家庭和自己创建的其他家庭），选择后立即切换。
- 长按顶部当前家庭名称弹出重命名弹窗；仅房主可重命名，服务端校验 owner 权限。
...
- Android 顶部家庭切换图标可下拉选择共享家庭，切换后能显示房主家庭的区域/位置/物品。
- Android 长按当前家庭名称可重命名（仅房主）。
